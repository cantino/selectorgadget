...
SelectorGadget.prototype.save = function() {
	...
	var endpoint = selectorGadgetIsLocal ? "http://localhost:3000/api/post" : "http://selectropolis.com/api/post";
...
SelectorGadget.prototype.reloadSelectors = function(selectors) {
	var self = this;
	jQuery.ajax({
		url: (selectorGadgetIsLocal ? "http://localhost:3000/api/list" : "http://selectropolis.com/api/list") + ("?url="+location.href),
		cache: false,
		dataType: "jsonp",
