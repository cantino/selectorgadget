...
SelectorGadget.prototype.setupEventHandlers = function() {
  $("*:not(.sg_ignore)").bind("mouseover.sg", { 'self': this }, this.sg_mouseover);
  $("*:not(.sg_ignore)").bind("mouseout.sg", { 'self': this }, this.sg_mouseout);
  $("*:not(.sg_ignore)").bind("click.sg", { 'self': this }, this.sg_click);
  $("html").bind("keydown.sg", { 'self': this }, this.listen_for_action_keys);
  $("html").bind("keyup.sg", { 'self': this }, this.clear_action_keys);
};
...
// 
//   // $("*").unbind("mouseover.sg");//, this.sg_mouseover);
//   // $("*").unbind("mouseout.sg");//, this.sg_mouseout);
//   // $("*").unbind("click.sg");//, this.sg_click);
//   // $("html").unbind("keydown.sg");//, this.listen_for_action_keys);
//   // $("html").unbind("keyup.sg");//, this.clear_action_keys);
// };
...
SelectorGadget.prototype.makeInterface = function() {
  ...
  this.sg_div.append($('<input type="button" value="X"/>').bind("click", {'self': this}, this.unbind).attr('class', 'sg_ignore'));
